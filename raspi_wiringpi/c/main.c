/***************************************************************************************
 * Project  :
 * Experimental Platform :Raspberry Pi 4B + 7.3inch E-Paper Display
 * Hardware Connection : 7.3inch E-Paper ->  Raspberry Pi 4B  in wiringpi number
...
****************************************************/
    ...
    const char* file_path = "./pic/a8.bmp";  //Path of the image to be imported
