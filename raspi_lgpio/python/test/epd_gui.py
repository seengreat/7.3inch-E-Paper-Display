...
class EPD_GUI():
    def __init__(self):
        ...
        self.epd.reset()
        self.epd.hw_init()
        self.img = [0xff for i in range(400000)]
        ...
        if EPD_WIDTH % 2 == 0:
            self.byte_w = EPD_WIDTH//2
        else:
            self.byte_w = (EPD_WIDTH // 2) + 1
    ...
    def draw_circle(self, x, y, r, color, fill, dot_pixel):
        ...
        while dy > dx:
            ...
            if d < 0:
                ...
                dy -= 1
            dx += 1
    def draw_str(self, x, y, text_str, color, bg_color, font_size, font):
